...
export async function createBadgeOperation(data){
        ...
        try{
            const response = await apiConnector("POST", createBadge, data, header, null);
...
export function allotBadgeOperation(data){
    return async(dispatch) => {
        try{
            const response = await apiConnector("POST", allotBadge, data, header, null);
...
export function getAllBadgesOperation(){
    return async(dispatch) =>{
        try{
            const response = await apiConnector("GET", getAllBadges, null, header, null);
...
export function getUserBadgesOperation(data){
    return async(dispatch) => {
        try{
            const response = await apiConnector("GET", getUserBadges, null, header, data);
